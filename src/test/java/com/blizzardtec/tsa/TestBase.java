...
public static final String FALLING_STRATEGY_FILE
   ...
   */
     ...
     * @param dateStr date to use
     * @param dateFormat format of the date
     * @param value the buy/sell value
     * @return data point
     */
    protected final DataPoint makePoint(
            final String dateStr, final String dateFormat, final float value) {
