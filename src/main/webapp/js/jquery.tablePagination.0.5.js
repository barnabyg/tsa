 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="image/first.gif",  
			prevArrow : (new Image()).src="image/prev.gif",
			lastArrow : (new Image()).src="image/last.gif",
			nextArrow : (new Image()).src="image/next.gif",
			rowsPerPage : 10,
			currPage : 1,
